...
import Image from '../../Assets/images/icons/mercadorias.jpg'
      ...
      <div className="ParticularesPage">
        <div className="CadPageContent" data-aos="fade-right">
          <div className="CadPageItem">
            ...
            <h1 className='cadTitle'>Mercadoria Transportada</h1>
          </div>
          <div className="descriptionCad">
            <p>{Data.MercadoriasTrans.Text}</p>
            <p>{Data.MercadoriasTrans.Text2}</p>
            <div className="listItem">
              {
                Data.MercadoriasTrans.Text3.map((item) => {
                  return (
                    <ul>
                      <li>{item}</li>
                    </ul>
