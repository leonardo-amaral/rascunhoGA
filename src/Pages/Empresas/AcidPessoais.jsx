...
import Image from '../../Assets/images/icons/acid-pess-emp.jpg'
      ...
      <div className="ParticularesPage">
        <div className="CadPageContent" data-aos="fade-right">
          <div className="CadPageItem">
            ...
            <h1 className='cadTitle'>Acidentes Pessoais</h1>
          </div>
          <div className="descriptionCad">
            <p>{Data.AcidPessoais.Text}</p>
            <p>{Data.AcidPessoais.Text2}</p>
            <p>{Data.AcidPessoais.Text4}</p>
          </div>
        </div>
