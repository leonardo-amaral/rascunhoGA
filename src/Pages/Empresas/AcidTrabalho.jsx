...
import Image from '../../Assets/images/icons/acid-emp.jpg'
      ...
      <div className="ParticularesPage">
        <div className="CadPageContent" data-aos="fade-right">
          <div className="CadPageItem">
            ...
            <h1 className='cadTitle'>Acidentes de Trabalho</h1>
          </div>
          <div className="descriptionCad">
            <p>{Data.AcidTrabalho.Text}</p>
            <p>{Data.AcidTrabalho.Text2}</p>
            <p>{Data.AcidTrabalho.Text3}</p>
          </div>
        </div>
