...
import Data from '../../Services/empresas.json'
import Image from '../../Assets/images/icons/RC.jpg'
      ...
      <div className="ParticularesPage">
        <div className="CadPageContent" data-aos="fade-right">
          <div className="CadPageItem">
            ...
            <h1 className='cadTitle'>Responsabilidade Civil</h1>
          </div>
          <div className="descriptionCad">
            <h1>{Data.RespCivil.Text}</h1>
            <p>{Data.RespCivil.Description}</p>
            <h1>{Data.RespCivil.Text2}</h1>
            <p>{Data.RespCivil.Description2}</p>
            <h1>{Data.RespCivil.Text3}</h1>
            <p>{Data.RespCivil.Description3}</p>
          </div>
        </div>
