...
import Image from '../../../Assets/images/icons/dental.jpg'
      ...
      <div className="ParticularesPage">
        <div className="CadPageContent" data-aos="fade-right">
          <div className="CadPageItem">
            ...
            <h1 className='cadTitle'>Dental</h1>
          </div>
          <div className="descriptionCad">
            <p>{Data.Dental.Text}</p>
            <div className="listItem">
              <p>{Data.Dental.Text2}</p>
            </div>
            <div className="listItem">
              <p>{Data.Dental.Text3}</p>
            </div>
            <div className="listItem">
              <p>{Data.Dental.Text4}</p>
            </div>
          </div>
        </div>
