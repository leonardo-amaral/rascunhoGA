...
import Image from '../../../Assets/images/icons/domestica.jpg'
      ...
      <div className="ParticularesPage">
        <div className="CadPageContent" data-aos="fade-right">
          <div className="CadPageItem">
            ...
            <h1 className='cadTitle'>Acidente Doméstico</h1>
          </div>
          <div className="descriptionCad">
            <p>{Data.AcidDomesticos.Text}</p>
            <div className="listItem">
              <p>{Data.AcidDomesticos.Text2}</p>
            </div>
          </div>
        </div>
